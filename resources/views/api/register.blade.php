...
<div class="container mx-auto flex pt-5 sm:pt-16" style="font-family: 'Montserrat', sans-serif" > 
    ...
    <form class="mx-auto w-screen " action="{{route('apiuserregister')}}" method="POST" >
        @csrf
            ...
            <div class="mx-auto text-center pt-20" > 
                <div class="flex justify-center items-baseline "> 
                    <div class=" h-10 w-10/12 flex border items-center rounded-full overflow-hidden hover:shadow-md" > 
                        ...
                        <span class="h-full px-4 bg-gray-400 text-xl pt-1"> <i class="fas fa-user "></i> </span>
                        <input id="name" type="string" name="name" class="focus:outline-none h-full w-full pl-1" value="{{ old('name') }}" placeholder="name"> 
                    </div>
                </div>
                @error('name')
                ...
                <div  class="flex justify-center items-baseline pt-8"> 
                    ...
                    <div class=" h-10 w-10/12 flex border items-center rounded-full overflow-hidden hover:shadow-md "> 
                        ...
                        <input id="email" type="email" name="email" class="focus:outline-none h-full w-full pl-1" value="{{ old('email') }}"placeholder="email"> 
                    </div>
                </div>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="flex justify-center items-baseline pt-8"> 
                    <div class="h-10 w-10/12 flex border items-center rounded-full overflow-hidden hover:shadow-md "> 
                        <label for="password-confirm" class="hidden"> Confirm Password: </label>
                        <span class="h-full px-4 bg-gray-400 text-xl pt-1"> <i class="fas fa-lock"></i> </span>
                        <input id="password-confirm" type="password" name="password_confirmation" class="focus:outline-none h-full w-full pl-1" placeholder="confirm password"> 
                    </div>
                </diV>
                <div class="mx-auto text-center w-10/12 pt-12  "> 
                    <button name="register" class="focus:outline-none w-full border py-2 px-4 bg-blue-500 rounded-full hover:shadow-md" type="submit">Register </button>
                </div>

                <div class="pt-2 pb-10"> 
                    <span> Already have an account? </span> <a href="{{route('apiuserloginform')}}" class="underline">  Login <a> 
                </div>
            </div>
        </div>
    </form>
